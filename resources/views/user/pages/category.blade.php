            ...
            <div class="ps-layout--shop">
                <div class="ps-layout__left">
                    <aside class="widget widget_shop">
                            ...
                            @foreach ($sub_categories as $sub_category)
                                @for ($i = 0; $i < count($sub_categories_count); $i++)
                                    @if ($sub_category->id === $sub_categories_count[$i]['id'])
                                        <p><a href="{{ $sub_category->slug }}">{{ $sub_category->category_name }} (
                                                {{ $sub_categories_count[$i]['count'] }} )</a></p>
                                    @endif
                                @endfor
                            @endforeach
                        </figure>
                            ...
                            @foreach ($brands as $brand)
                                @for ($i = 0; $i < count($brands_count); $i++)
                                    @if ($brand->id === $brands_count[$i]['id'])
                                        <p><a class="filter_brand" href="javascript:void(0)"
                        ...
                        <figure>
                            <a href="{{ route('category', $slug_category_name) }}"
