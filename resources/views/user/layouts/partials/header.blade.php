                            ...
                            <div class="col d-none d-xl-block">
                                <form class="js-focus-state">
                                    ...
                                    <div class="input-group">
                                        <input type="email" class="form-control py-2 pl-5 font-size-15 border-right-0 height-42 border-width-0 rounded-left-pill border-primary" name="email" id="searchproduct-item" placeholder="Məhsulları axtar" aria-label="Məhsulları axtar" aria-describedby="searchProduct1" required="">
                                ...
                                <div class="d-inline-flex">
                                    <ul class="d-flex list-unstyled mb-0 align-items-center">
                                        ...
                                        <li class="col d-xl-none px-2 px-sm-3 position-static">
                                            ...
                                            <div id="searchClassic" class="dropdown-menu dropdown-unfold dropdown-menu-right left-0 mx-2" aria-labelledby="searchClassicInvoker">
                                                <form class="js-focus-state input-group px-3">
                                                    <input class="form-control" type="search" placeholder="Məhsulları axtar">
                                                    <div class="input-group-append">
                                        ...
                                        <li class="col d-block">
                                            <a href="../shop/wishlist.html" class="text-gray-90" data-toggle="tooltip" data-placement="top" title="Seçilmişlər">
                                                <i class="font-size-22 far fa-heart"></i>
                                            </a>
                                        </li>
                                        <li class="col d-block px-2 px-sm-3">
                                            <a href="../shop/my-account.html" class="text-gray-90" data-toggle="tooltip" data-placement="top" title="Hesabım">
                                    ...
                                    <div id="basicsAccordion">
                                        ...
                                        <div class="card border-0">
                                            <div class="card-header card-collapse btn-remove-bg-hover border-0" id="basicsHeadingOne">
                                                <button type="button" class="btn-link btn-remove-bg-hover btn-block d-flex card-btn pyc-10 text-lh-1 pl-0 pr-4 shadow-none btn-primary bg-transparent rounded-top-lg border-0 font-weight-bold text-gray-90" data-toggle="collapse" data-target="#basicsCollapseOne" aria-expanded="true" aria-controls="basicsCollapseOne">
                                                                ...
                                                                <li class="nav-item hs-has-sub-menu u-header__nav-item" data-event="click" data-animation-in="slideInUp" data-animation-out="fadeOut" data-position="left">
                                                                    ...
                                                                    <ul id="homeSubMenu" class="hs-sub-menu u-header__sub-menu animated hs-position-left fadeOut" aria-labelledby="homeMegaMenu" style="min-width: 230px; display: none;">
                                                                        ...
                                                                        <li class="hs-has-sub-menu">
                                                                            <a class="nav-link u-header__sub-menu-nav-link " href="{{ route('home') }}">Home-v1</a>
                                                                        </li>
                                                                        <!-- End Home-v1 -->
                                                ...
                                                <div class="hs-mega-menu w-100 u-header__sub-menu" aria-labelledby="homeMegaMenu">
                                                    <div class="row u-header__mega-menu-wrapper">
                                                        <div class="col-md-3">
                                                            ...
                                                            <ul class="u-header__sub-menu-nav-group">
                                                                <li><a href="{{ route('home') }}" class="nav-link u-header__sub-menu-nav-link">Home v1</a></li>
