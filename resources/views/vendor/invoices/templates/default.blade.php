...
<html lang="en">
    ...
    <body>
        ...
        <table class="table table-items">
            <thead>
                <tr>
                    <th scope="col" class="border-0 pl-0">Məhsul adı</th>
                    @if($invoice->hasItemUnits)
                        <th scope="col" class="text-center border-0">Parametrləri</th>
                    @endif
                    <th scope="col" class="text-center border-0">Miqdar</th>
                    <th scope="col" class="text-right border-0">Qiyməti</th>
                    @if($invoice->hasItemDiscount)
                        <th scope="col" class="text-right border-0">Endirim faizi</th>
                    @endif
                    @if($invoice->hasItemTax)
                        <th scope="col" class="text-right border-0">{{ __('invoices::invoice.tax') }}</th>
                    @endif
                    <th scope="col" class="text-right border-0 pr-0">Cəmi qiymət</th>
                </tr>
            </thead>
            <tbody>
                {{-- Items --}}
                ...
                <tr>
                    ...
                    @if($invoice->hasItemUnits)
                        <td class="text-center">{{-- {{ __('invoices::invoice.units') }} --}} {{ $item->units }}</td>
                    @endif
