            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        {{-- <img src="{{ asset('img/' . old('logo', $website_info->logo)) }}" class="user-image" alt="User Image"> --}}
                        <span class="hidden-xs">{{ auth('manage')->user()->first_name.' '. auth('manage')->user()->last_name }}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="{{ asset('assets/img/' . old('logo', $website_info->logo)) }}" class="img-circles" alt="User Image">
                ...
                <li><a href="{{ route('home') }}" target="_blank"><i class="fa fa-eye"></i> @lang('admin.Go To Website')</a></li>
