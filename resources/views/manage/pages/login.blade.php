...
<div class="login-box">
    <div class="login-logo">
        <b>İdarəetmə Paneli</b>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Sessiyaya başlamaq üçün daxil olun</p>
        ...
        <form action="{{ route('manage.login') }}" method="post" autocomplete="off" >
            ...
            <div class="form-group has-feedback">
                <input type="email" name="email" id="email" class="form-control" placeholder="Email" autocomplete="email" autofocus>
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="password" name="password" id="password" class="form-control" placeholder="Şifrə" autocomplete="current-password">
