...
@section('title', "Kompaniya İdarəetmə")
@section('head')
...
@endsection
@section('content')
    <form id="company-form"  action="{{ route('manage.company.save', @$flight->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        <section class="content-header">
            <h1 class="pull-left">Kompaniya</h1>
            <div class="pull-right">
                @if($flight->id>0)
                    <a href="{{ route('manage.company.new') }}"
                       class="btn btn-success"> Yeni Kompaniya</a>
                                ...
                                <div class="col-md-12">
                                    <div class="jumbotron text-center">
                                        <p>
                                            ...
                                            Tövsiyyə edilən şəkil ölçüsü 310x188
                                        </p>
                                        <div class="row">
                                            <div class="col-md-12">
                                ...
                                <div class="col-md-6 form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="slug"
                                               ...
                                               name="slug"
                                               value="{{ old('slug', $flight->slug) }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="active">@lang('admin.Active')</label>
                                        <select name="active" id="active" class="form-control">
                                            <option value="1" {{ $flight->active ? 'selected' : '' }}>@lang('admin.Active')</option>
                                            <option value="0" {{ !$flight->active ? 'selected' : '' }}>@lang('admin.Passive')</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
...
@section('footer')
    <script type="text/javascript">
        ...
        image_crop.croppie('bind', {
            url: "{{ asset('assets/img/company/' . $flight->image) }}",
        });
        ...
        $('#company-form').submit(function(event) {
            ...
            image_crop.croppie('result', {
                ...
                ajaxFormPost(formData, "{{ route('manage.company.save') }}");
            });
        })
        /// Ajax Function
