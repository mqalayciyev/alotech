...
@section('content')
    ...
    <section class="content-header">
        <h1 class="pull-left">Xidmətlər</h1>
        <div class="pull-right">
            <button class="btn btn-success" id="add_data">
                <i class="fa fa-plus"></i> Yeni Xidmət
            </button>
        </div>
                                ...
                                <div class="modal-content">
                                    <form method="post" id="form">
                                        ...
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Yeni Xidmət</h4>
                                        </div>
                                        <div class="modal-body">
                                            <span id="form_output"></span>
                                            <div class="form-group">
                                                <label for="services_name">@lang('admin.Category Name')</label> <br>
                                                <input type="text" name="services_name" class="form-control"
                                                    id="services_name" placeholder="@lang('admin.Category Name')"
                                        ...
                                        <div class="modal-body">
                                            <span id="form_output"></span>
                                            <div class="form-group">
                                                <label for="services_price">Qiyməti</label> <br>
                                                <input type="text" name="services_price" class="form-control"
                                                    id="services_price" placeholder="Qiyməti"
                                                    value="{{ old('services_price') }}">
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            ...
                                            <input type="submit" name="submit" id="action"
                                                class="btn btn-success" value="Xidmət Əlavə et" />
                                        </div>
                                    </form>
                                </div>
                                <!-- /.modal-content -->
    ...
    <script>
        $(function() {
            ...
            $('#index_table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ route('manage.services.index_data') }}',
                columns: [{
                        data: 'services_name'
                    },
                    {
            ...
            $('#form').on('submit', function(event) {
                ...
                $.ajax({
                    method: 'POST',
                    url: '{{ route('manage.services.post_data') }}',
                    data: form_data,
                    cache: false,
                    processData: false,
                    contentType: false,
            ...
            $(document).on('click', '.edit', function() {
                var id = $(this).attr('id');
                $.ajax({
                    url: '{{ route('manage.services.fetch_data') }}',
                    method: 'GET',
                    data: {
                        id: id
                    },
            ...
            $(document).on('click', '.delete', function() {
                ...
                if (confirm('{{ __('admin.Are you sure you want to delete this data?') }}')) {
                    $.ajax({
                        url: '{{ route('manage.services.delete_data') }}',
                        method: 'GET',
                        data: {
                            id: id
                        },
            ...
            $(document).on('click', '#bulk_delete', function() {
                ...
                if (confirm('{{ __('admin.Are you sure you want to delete this data?') }}')) {
                    ...
                    if (id.length > 0) {
                        $.ajax({
                            url: '{{ route('manage.services.mass_remove') }}',
                            method: 'GET',
                            data: {
                                id: id
                            },
